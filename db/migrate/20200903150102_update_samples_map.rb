class UpdateSamplesMap < ActiveRecord::Migration[5.2]
  def up
    ...
    sql = <<~SQL
      ...
      samples.geom, samples.geom_projected,
    ...
    add_index :samples_map, :geom_projected, using: :gist
    add_index :samples_map, :geom, using: :gist
  end
