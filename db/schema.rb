...
ActiveRecord::Schema.define(version: 20180514134117) do
  ...
  create_table "cal_taxa", id: :integer, default: -> { "nextval('cal_taxa_taxonid_seq'::regclass)" }, force: :cascade do |t|
    ...
    t.datetime "created_at",         default: '2018-05-14 17:10:24',                              null: false
    t.datetime "updated_at",         default: '2018-05-14 17:10:24',                              null: false
