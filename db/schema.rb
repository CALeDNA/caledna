...
ActiveRecord::Schema.define(version: 20180512100846) do
  ...
  create_table "cal_taxa", id: :integer, default: -> { "nextval('cal_taxa_taxonid_seq'::regclass)" }, force: :cascade do |t|
    ...
    t.datetime "created_at",         default: '2018-05-12 21:52:12',                              null: false
    t.datetime "updated_at",         default: '2018-05-12 21:52:12',                              null: false
