...
ActiveRecord::Schema.define(version: 2019_07_01_003222) do
  ...
  create_table "combine_taxa", force: :cascade do |t|
    ...
    t.index ["caledna_taxon_id"], name: "index_combine_taxa_on_caledna_taxon_id"
    t.index ["phylum"], name: "combine_taxa_phylum_idx"
    t.index ["source_taxon_id", "source"], name: "combine_taxa_source_taxon_id_source_idx", unique: true
