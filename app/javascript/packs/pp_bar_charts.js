...
$(function() {
  ...
  createChart("inat-total-chart", window.caledna.inat_division_total);
  createChart("inat-unique-chart", window.caledna.inat_division_unique);

  createChart("only-inat-unique-chart", window.caledna.only_inat_unique_data);
  createChart(
    "exclude-inat-unique-chart",
    window.caledna.exclude_inat_unique_data
  );
  createChart(
    "only-inat-occurrences-chart",
    window.caledna.only_inat_occurrences_data
  );
  createChart(
    "exclude-inat-occurrences-chart",
    window.caledna.exclude_inat_occurrences_data
  );
});
