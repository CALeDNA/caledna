...
describe ResearchProject do
  ...
  describe '#show_pages?' do
    it 'returns true if research project has any published pages' do
      ...
      create(:research_project_page, published: true, research_project: project)
      create(:research_project_page, published: false,
  ...
  describe '#default_page' do
    ...
    it 'return the first published page sorted by display order' do
      ...
      create(:research_project_page, published: true, research_project: project,
                                     display_order: 2)
      page = create(:research_project_page, published: true,
                                            research_project: project,
                                            display_order: 1)
      create(:research_project_page, published: true,
                                     research_project: project,
                                     display_order: 3)
  ...
  describe '#project_pages' do
    ...
    it 'returns published page sorted by display order' do
      project = create(:research_project)
      page2 = create(:research_project_page, published: true,
                                             research_project: project,
                                             display_order: 2)
      page1 = create(:research_project_page, published: true,
                                             research_project: project,
                                             display_order: 1)
      page3 = create(:research_project_page, published: true,
                                             research_project: project,
                                             display_order: 3)
